<?php
$options = array();
$options['title'] = 'User Signup'; // what you call your content
$options['description'] = 'New User Signup System'; // a brief description of what your content does, any restrictions, etc
