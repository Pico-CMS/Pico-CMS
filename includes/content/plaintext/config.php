<?php
$options = array();
$options['title'] = 'Plain Text'; // what you call your content
$options['description'] = 'Simple plain text or html'; // a brief description of what your content does, any restrictions, etc
