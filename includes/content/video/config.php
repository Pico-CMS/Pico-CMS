<?php
$options = array();
$options['title'] = 'Video Player'; // what you call your content
$options['description'] = 'Standalone Video Player'; // a brief description of what your content does, any restrictions, etc
...
$options['edit_options'] = array(
	array(
		'container'=>'player_options',
		'link_text'=>'Player Options',
		'inc_file'=>'player_options.php',
		'access'=>3
	),
