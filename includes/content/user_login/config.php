<?php
$options = array();
$options['title'] = 'User Login'; // what you call your content
$options['description'] = 'User login component'; // a brief description of what your content does, any restrictions, etc
