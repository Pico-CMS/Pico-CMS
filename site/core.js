...
Ajax.Form = Class.create(Ajax.Request, {
	initialize: function ($super, form, options)
	{
		if (options == null)
		{
			options = {};
		...
		this.form = form;
		this.transport = Ajax.getTransport();
		options.method = this.form.method || 'post';
		options.parameters = $(form).serialize(true);
		this.request(this.form.action, options);
	},
	setParameters: function()
	{
		this.options.parameters = $(this.form).serialize(true);
	},
